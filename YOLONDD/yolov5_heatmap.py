...
def get_params():
    params = {
        'weight': 'exp9/weights/best.pt',#387   178

        'device': 'cuda:0',
        'method': ' GradCAMPlusPlus',
        # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM  1, RandomCAM, EigenGradCAM
        'layer': [17],
        'backward_type': 'all',  # class, box, all
        'conf_threshold': 0.95,  # 0.6
        'ratio': 0.02,  # 0.02-0.1
        'show_box': False,
        'renormalize': True
    }
...
if __name__ == '__main__':
    ...
    model(r'data/images/img1.png', 'result')