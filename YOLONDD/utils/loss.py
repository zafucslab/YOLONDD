...
from utils.metrics import bbox_iou, bbox_mpdiou, box_iou
    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                #iou = bbox_mpdiou(pbox, tbox[i], grid=torch.transpose(torch.stack([gj, gi]), dim0=1, dim1=0), wh=pi.size(2)**2+pi.size(3)**2).squeeze()
